...
class LeavesControllerTest < ActionController::TestCase
  ...
  test "should create leafe" do
    assert_difference('Leave.count') do
      post :create, leafe: { employee_id: @leafe.employee_id, finish: @leafe.finish, start: @leafe.start }
    end
  ...
  test "should update leafe" do
    patch :update, id: @leafe, leafe: { employee_id: @leafe.employee_id, finish: @leafe.finish, start: @leafe.start }
    assert_redirected_to leafe_path(assigns(:leafe))
  end
